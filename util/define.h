...
#define MKCLASS(cl) inline virtual const std::string& GetClass() const override {const static std::string s = cl; return s;}
/// Macro to define the Type of an object (for method GetType)
#define MKTYPE(cl) inline virtual const std::string& GetType() const override {const static std::string s = cl; return s;}
/// Macro to define the Type of an object (for method GetType)
#define MKPARAMTYPE(cl) inline virtual const ParameterType& GetParameterType() const override {const static ParameterType s = cl; return s;}
/// Macro to define the Category of an object (for method GetCategory)
#define MKCATEG(cl) inline virtual const std::string& GetCategory() const override {const static std::string s = cl; return s;}
