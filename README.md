...
These libraries and utilities can be installed to create advanced modules:
	...
	sudo apt-get install cmake-qt-gui cmake-curses-gui qtcreator python-dev cxxtest libcurl4-openssl-dev python-opencv python-sklearn python-numpy python-skimage libav-tools  python-pymongo python-gridfs mongodb
