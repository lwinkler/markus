...
int main(int argc, char *argv[])
{
	...
	const string NAME = source.substr(0, pAt) + "_out_" + argv[2][0] + ".avi";   // Form the new name with container
	...
	outputVideo.open(NAME, CV_FOURCC('M','J','P','G'), inputVideo.get(CV_CAP_PROP_FPS), S, true);
