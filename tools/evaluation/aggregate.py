...
def list_analyses(path, dirname='analysis', checkname='evals.pkl'):
	...
	# Filter
	is_valid = lambda x: os.path.exists(os.path.join(path, x, dirname, checkname))
...
def arguments_parser():
	...
	# Main parser
	parser = argparse.ArgumentParser(description='Aggregate results on several videos')
