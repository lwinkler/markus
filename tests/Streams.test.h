...
public:
	void setUp()
	{
		...
		mp_fakeParams1->Initialize(m_config.Find("application>module[name=\"FakeModule\"]"));
		mp_fakeParams2->Initialize(m_config.Find("application>module[name=\"FakeModule\"]"));
		mp_fakeParams3->Initialize(m_config.Find("application>module[name=\"FakeModule\"]"));
