...
log4cxx::LoggerPtr StatModel::m_logger(log4cxx::Logger::getLogger("StatModel"));

StatModel::StatModel(ParameterStructure& xr_params)
	: Module(xr_params),
