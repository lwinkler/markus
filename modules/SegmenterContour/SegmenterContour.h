...
public:
	class Parameters : public Module::Parameters
	{
			...
			Parameters(const ConfigReader& x_confReader) : Module::Parameters(x_confReader)
		{
            ...
            m_list.push_back(new ParameterString("features",     "x,y,width,height",           &features,   "List of features to extract, separated with ',' possible: x,y,width,height,area,ellipse_{angle,cos,ratio,width,height}, moment_{00,11,20,02}, hu_moment_{1-7}"));
