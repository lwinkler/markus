...
cv::Ptr<cv::Feature2D> Feature2D::create(const mkjson& x_config) {
	...
	if(name == "cv::FastFeatureDetector" && num == 0)
	...
	if(name == "cv::AgastFeatureDetector" && num == 0)
