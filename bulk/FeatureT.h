...
public:
	...
	inline virtual void Serialize(MkJson& x_out, const std::string& x_dir) const { std::stringstream ss; serialize(ss, value); std::cout<<"BAAAA"<<ss.str()<<std::endl; ss >> x_out;}
