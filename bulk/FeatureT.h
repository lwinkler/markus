...
public:
	...
	inline virtual void Serialize(MkJson x_out, const std::string& x_dir) const { /* TODO std::stringstream ss; serialize(ss, value); std::cout<<"BAAAA"<<ss.str()<<std::endl; ss >> (*x_out); */}
	inline virtual void Deserialize(MkJson x_in, const std::string& x_dir) {/* std::stringstream ss; ss << *x_in; deserialize(ss, value);*/}
