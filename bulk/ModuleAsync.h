...
public:
	...
	{
		m_list.push_back(new ParameterDouble("detectionFps", 	10, 	PARAM_DOUBLE, 	0, 	100,		&detectionFps,	"Frames per seconds for the asynchronous detection (normally smaller that module)"));
	};
...
protected:
	...
	inline virtual bool IsInputProcessed() {return m_currentTimeStamp - m_timeStampLastThread >= 1 / RefParameter().detectionFps;};
