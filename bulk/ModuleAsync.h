...
public:
	...
	{
		m_list.push_back(new ParameterDouble("detectionFps", 	10, 	PARAM_DOUBLE, 	0, 	1000,		&detectionFps,	"Frames per seconds for the asynchronous detection (normally smaller that module)"));
	};
