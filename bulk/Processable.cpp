...
bool Processable::ProcessAndCatch()
{
	...
	catch(FatalException& e)
	{
		...
		continueFlag = recover = m_hasRecovered = false;
		m_lastException = e;
	...
	continueFlag = continueFlag; // TODO && (m_param.nbFrames == 0 || m_param.nbFrames != m_frameCount);
	if(AbortCondition()) // TODO : check each 10 frames
		continueFlag = false;
